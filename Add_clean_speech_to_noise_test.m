...
[speech_ch1, fsN1] = audioread('C:/Users/Montu/Desktop/Speech_Denoising/Data/clean_speech_test.wav');
    
%Load the noise signal (change the data)
...
audiowrite('noisyAudio_30dB_6min_babble_noise_testing.wav',noisy, fs2);
